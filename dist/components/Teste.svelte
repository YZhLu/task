<script>let title = "task.name";
let skills = [
  {
    id: "7572a5ec-3422-47b1-93d0-36ea77b51f15",
    label: "Raz & Prop (a)",
    description: "Raz\xE3o entre segmentos e segmentos proporcionais -\xA0Definir a raz\xE3o entre dois segmentos.",
    createdAt: "2023-05-15T19:53:43.113Z",
    updatedAt: "2023-05-15T19:53:43.113Z"
  }
];
</script>
